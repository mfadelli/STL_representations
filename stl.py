...
#TESTING
#formula is G[0,5](NOT(x_1>=1) AND F_[2,3](x_2<=-1))
#a=Atom(1,1,False)
#b=Atom(2,-1,True)
#nt=Not(a)
#f=Eventually(b,False,False,2,3)
#nd=And(nt,f)
#g=Globally(nd,False,False,1,5)
#print(g.time_depth()) #=8
#print(g.__str__()) #always[1,6] ( ( not ( x_1 >= 1 ) and eventually[2,4] ( x_2 <= -1 ) ) )

#import traj_measure
#m=traj_measure.BaseMeasure()
#x=m.sample(samples=1,varn=3)
#print(g.quantitative(x,False,False)) #single real number